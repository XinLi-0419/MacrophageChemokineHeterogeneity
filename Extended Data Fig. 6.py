...
DATABASES_GLOB = os.path.join("/Volumes/mLu/Analysis/scRNA_seq/Datasets/SCENIC/Regulon_Databases", "mm10_10kbp_up_10kbp_down_full_tx_v10_clust.genes_vs_motifs.rankings.feather")
...
REGULONS_FNAME = os.path.join("/Volumes/mLu/Analysis/scRNA_seq/Datasets/SCENIC", "mLu.combined.IMs.10k.10k.regulons.p")
MOTIFS_FNAME = os.path.join("/Volumes/mLu/Analysis/scRNA_seq/Datasets/SCENIC", "mLu.combined.IMs.10k.10k.motifs.csv")
AUC_FNAME=os.path.join("/Volumes/mLu/Analysis/scRNA_seq/Datasets/SCENIC", "mLu.combined.IMs.10k.10k.auc.tsv")
...
REGULONS_FNAME = os.path.join("/Volumes/mLu/Analysis/scRNA_seq/Datasets/SCENIC", "mLu.combined.IMs.10k.10k.regulons.csv")
